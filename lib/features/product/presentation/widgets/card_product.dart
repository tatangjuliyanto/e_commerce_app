...
Widget cardProduct(BuildContext context, ProductState state) {
  if (state is ProductLoading) {
    ...
    return _buildProductListState(state.products);
  } else if (state is ProductError) {
    return _buildErrorProductState(context, state.message);
  }
...
Widget _buildProductListState(List<Product> products) {
...
Widget _buildErrorProductState(BuildContext context, String message) {
  return Center(
    child: Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
